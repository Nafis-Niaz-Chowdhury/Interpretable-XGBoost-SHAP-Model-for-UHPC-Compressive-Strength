...
# Q1 Journal–Ready Full Pipeline (FINAL v2)
# ============================================================
...
# ============================================================
# 10. ALL MODEL GRAPHS (INCLUDING RESIDUAL SCATTER)
# ============================================================
for name, pred in results.items():
    ...
    # --- Residual Scatter Plot (IMPORTANT) ---
    plt.figure(figsize=(6,5))
    plt.scatter(pred, residuals, alpha=0.7)
    plt.axhline(0, color="red", linestyle="--")
    plt.xlabel("Predicted CS")
    plt.ylabel("Residuals (Actual − Predicted)")
    plt.title(f"Residual Scatter Plot – {name}")
    plt.grid(True)
    plt.tight_layout()
    plt.savefig(f"Fig_ResidualScatter_{name}.png", dpi=600)
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig(f"Fig_ResidualHist_{name}.png", dpi=600)
    plt.show()
...
# ============================================================
# END OF FINAL Q1-READY PIPELINE
# ============================================================
